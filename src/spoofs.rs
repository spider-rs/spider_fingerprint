...
pub const PLUGIN_AND_MIMETYPE_SPOOF_CHROME: &str = r#"(()=>{const m=[{type:'application/pdf',suffixes:'pdf',description:'Portable Document Format'},{type:'text/pdf',suffixes:'pdf',description:'Portable Document Format'}],names=['PDF Viewer','Chrome PDF Viewer','Chromium PDF Viewer','Microsoft Edge PDF Viewer','WebKit built-in PDF'],plugins=[],mimes=[];let mt1=null,mt2=null;names.forEach(name=>{const plugin=Object.create(Plugin.prototype);Object.defineProperties(plugin,{name:{value:name},description:{value:'Portable Document Format'},filename:{value:'internal-pdf-viewer'},length:{value:2}});if(!mt1){mt1=Object.create(MimeType.prototype);Object.defineProperties(mt1,{type:{value:m[0].type},suffixes:{value:m[0].suffixes},description:{value:m[0].description},enabledPlugin:{value:plugin}});mt2=Object.create(MimeType.prototype);Object.defineProperties(mt2,{type:{value:m[1].type},suffixes:{value:m[1].suffixes},description:{value:m[1].description},enabledPlugin:{value:plugin}});mimes.push(mt1,mt2)}plugin[0]=mt1;plugin[1]=mt2;plugins.push(plugin)});Object.defineProperties(PluginArray.prototype,{item:{value:function(i){return this[i]||null}},namedItem:{value:function(n){return this[n]||null}},toJSON:{value:function(){return[...Array(this.length)].map((_,i)=>this[i])}}});Object.defineProperties(MimeTypeArray.prototype,{item:{value:function(i){return this[i]||null}},namedItem:{value:function(n){return this[n]||null}}});const pa=Object.create(PluginArray.prototype),ma=Object.create(MimeTypeArray.prototype);plugins.forEach((p,i)=>{Object.defineProperty(pa,i,{value:p,enumerable:true});Object.defineProperty(pa,p.name,{value:p})});Object.defineProperty(pa,'length',{value:plugins.length,enumerable:false});mimes.forEach((mt,i)=>{Object.defineProperty(ma,i,{value:mt,enumerable:true});Object.defineProperty(ma,mt.type,{value:mt})});Object.defineProperty(ma,'length',{value:mimes.length,enumerable:false});const g=(v,n)=>{const f=()=>v;Object.defineProperty(f,'toString',{value:()=>`function get ${n}() { [native code] }`});return f};Object.defineProperties(Navigator.prototype,{plugins:{get:g(pa,'plugins')},mimeTypes:{get:g(ma,'mimeTypes')}})})();"#;
...
/// Patch the speech synthesis for chrome.
pub const PATCH_SPEECH_SYNTHESIS: &str = r#"(()=>{const g=globalThis||window;if(!g.speechSynthesis||!g.SpeechSynthesisVoice)return;const S=(f,n=f.name||"")=>Object.defineProperty(f,"toString",{value:function(){return"function "+n+"() { [native code] }"},configurable:!0}),D=(o,k,v)=>Object.defineProperty(o,k,{value:v,enumerable:!0});const orig=g.speechSynthesis.getVoices.bind(g.speechSynthesis),mk=(u,n,l,ls,d)=>{const v=Object.create(g.SpeechSynthesisVoice.prototype);D(v,"voiceURI",""+u),D(v,"name",""+n),D(v,"lang",""+l),D(v,"localService",!!ls),D(v,"default",!!d);return v};const EXTRA=[["Google US English","Google US English","en-US",!1,!1],["Google UK English Female","Google UK English Female","en-GB",!1,!1],["Google UK English Male","Google UK English Male","en-GB",!1,!1],["Google espa\u00f1ol","Google espa\u00f1ol","es-ES",!1,!1],["Google espa\u00f1ol de Estados Unidos","Google espa\u00f1ol de Estados Unidos","es-US",!1,!1],["Google fran\u00e7ais","Google fran\u00e7ais","fr-FR",!1,!1],["Google \u0939\u093f\u0902\u0926\u0940","Google \u0939\u093f\u0902\u0926\u0940","hi-IN",!1,!1],["Google Bahasa Indonesia","Google Bahasa Indonesia","id-ID",!1,!1],["Google Deutsch","Google Deutsch","de-DE",!1,!1],["Google italiano","Google italiano","it-IT",!1,!1],["Google \u65e5\u672c\u8a9e","Google \u65e5\u672c\u8a9e","ja-JP",!1,!1],["Google \ud55c\uad6d\uc5b4","Google \ud55c\uad6d\uc5b4","ko-KR",!1,!1],["Google Nederlands","Google Nederlands","nl-NL",!1,!1],["Google polski","Google polski","pl-PL",!1,!1],["Google portugu\u00eas do Brasil","Google portugu\u00eas do Brasil","pt-BR",!1,!1],["Google \u0440\u0443\u0441\u0441\u043a\u0438\u0439","Google \u0440\u0443\u0441\u0441\u043a\u0438\u0439","ru-RU",!1,!1],["Google \u666e\u901a\u8bdd\uff08\u4e2d\u56fd\u5927\u9646\uff09","Google \u666e\u901a\u8bdd\uff08\u4e2d\u56fd\u5927\u9646\uff09","zh-CN",!1,!1],["Google \u7cb5\u8a9e\uff08\u9999\u6e2f\uff09","Google \u7cb5\u8a9e\uff08\u9999\u6e2f\uff09","zh-HK",!1,!1],["Google \u570b\u8a9e\uff08\u81fa\u7063\uff09","Google \u570b\u8a9e\uff08\u81fa\u7063\uff09","zh-TW",!1,!1]].map(a=>mk(...a));let cache=null,shot=!1;const merge=r=>{const seen=new Set,out=[],push=v=>{const k=((v&&v.voiceURI)||"")+"::"+((v&&v.name)||"")+"::"+((v&&v.lang)||"");if(!seen.has(k)){seen.add(k);out.push(v)}};r.forEach(push),EXTRA.forEach(push);if(!out.some(v=>v.default===!0)){const i=out.findIndex(v=>((v.lang||"")+"").toLowerCase().indexOf("en")===0);if(i>=0){const x=out[i];out[i]=mk(x.voiceURI,x.name,x.lang,x.localService,!0)}}return out};const patched=function getVoices(){const real=(()=>{try{return orig()||[]}catch(e){return[]}})();if(!cache||cache.__len!==real.length){const m=merge(real);m.forEach(Object.freeze),Object.defineProperty(m,"__len",{value:real.length}),cache=Object.freeze(m.slice());if(!shot){shot=!0,queueMicrotask(()=>{try{g.speechSynthesis.dispatchEvent(new Event("voiceschanged"))}catch(e){}})}}return cache};Object.defineProperty(g.speechSynthesis,"getVoices",{value:patched,writable:!1,enumerable:!1,configurable:!0}),S(patched,"getVoices")})();"#;
...
pub fn spoof_media_labels_script(agent_os: AgentOs) -> String {
    let camera_label = match agent_os {
        ...
        AgentOs::Linux | AgentOs::Unknown | AgentOs::ChromeOS => "Integrated Camera",
        AgentOs::Android | AgentOs::IPhone | AgentOs::IPad => "Front Camera",
    };
...
pub fn spoof_screen_script_rng<R: Rng>(
    ...
    let color_depth = match agent_os {
        AgentOs::Mac | AgentOs::Windows | AgentOs::Linux | AgentOs::Unknown | AgentOs::ChromeOS => {
            if simulate_hdr {
                30
            } else {
                24
        ...
        AgentOs::Android | AgentOs::IPhone | AgentOs::IPad => 24,
    };
    ...
    device_scale_factor.unwrap_or_else(|| {
        if emulating_mobile {
            ...
            match platform {
                ...
                AgentOs::Android | AgentOs::IPhone | AgentOs::IPad => 2.0, // can be 3.0+ on some phones, but 2.0 is safe default
                AgentOs::ChromeOS => 1.6,
            }
        }
    })
}
